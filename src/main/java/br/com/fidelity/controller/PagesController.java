...
public class PagesController {
	...
	public String assocPage(Model model, Authentication authentication) {
		Estabelecimento estab = estabelecimentoRepository
				.findByUsuario(membroRepository.findByUsuario(authentication.getName()));
		/*Associacao associacao = new Associacao();
		associacao.setUsuarioCli(clienteRepository.findByUsuario(membroRepository.findByUsuario("xpto")));
		associacao.setUsuarioEstab(estabelecimentoRepository.findByUsuario(membroRepository.findByUsuario(authentication.getName())));
		...
		ponto1.setIdAssoc(associacao);
		ponto1.setData(timeUtils.sdfDate.format(timeUtils.getTime()));
		ponto1.setHora(timeUtils.sdfTime.format(timeUtils.getTime()));
		ponto1.setValor(0);
		
		Ponto ponto2 = new Ponto();
		ponto2.setIdAssoc(associacao);
		ponto2.setData(timeUtils.sdfDate.format(timeUtils.getTime()));
		ponto2.setHora(timeUtils.sdfTime.format(timeUtils.getTime()));
		ponto2.setValor(0);
		
		pontoRepository.save(ponto1);
		pontoRepository.save(ponto2);*/
